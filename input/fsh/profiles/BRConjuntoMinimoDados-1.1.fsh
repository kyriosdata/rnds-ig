Profile: BRConjuntoMinimoDadosV11
Parent: Composition
Id: 521287f6-fd07-498d-aec2-1dff41af31ba
...
* ^meta.versionId = "1"
* ^meta.lastUpdated = "2020-06-09T14:31:10.273+00:00"
* ^language = #pt-BR
* ^url = "http://www.saude.gov.br/fhir/r4/StructureDefinition/BRConjuntoMinimoDados-1.1"
* ^version = "1.1"
* ^status = #active
* ^date = "2020-06-09T14:31:33.8335625Z"
...
* section[diagnosticosAvaliados].emptyReason ..0 MS
...
* section[problemasAvaliados].emptyReason ..0 MS
