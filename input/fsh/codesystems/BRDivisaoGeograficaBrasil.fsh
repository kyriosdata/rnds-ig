...
* ^language = #pt-BR
* ^url = "http://www.saude.gov.br/fhir/r4/CodeSystem/BRDivisaoGeograficaBrasil"
* ^version = "201701A"
* ^status = #active
* ^experimental = false
...
* #3 #34 "São Paulo"
* #3 #34 ^property[0].code = #type
* #3 #34 ^property[=].valueCode = #state
* #3 #34 ^property[+].code = #initials
* #3 #34 ^property[=].valueCode = #SP
* #4 "Sul"
